...
function parsePrivacyLog(privacyLog) {
  ...
  if (privacyLog.used && typeof privacyLog.used === 'object') {
    ...
    usedItems.forEach(item => {
      ...
      else if (item.includes('contact') || item.startsWith('Recipient:')) usedContacts++;
...
console.log('  Expected USED: "1 message, 1 contact"');
console.log('  Expected NOT USED: "47 messages, 12 files, 8 events, 15 contacts"\n');
...
console.log('  Expected USED: "2 files" (or similar)');
console.log('  Expected NOT USED: "43 files, 20 messages, 10 events"\n');
...
console.log('  Expected USED: "1 event, 1 contact"');
console.log('  Expected NOT USED: "35 events, 50 messages, 12 files"\n');
...
console.log('  Expected USED: "1 message, 1 contact"');
console.log('  Expected NOT USED: "30 messages, 10 files, 8 events"\n');

console.log('\nIf all results match expectations, the parsing logic is correct!');
